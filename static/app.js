const THREAD_KEY = 'ai_operations_assistant_thread_id';
...
function addMessage(role, html, meta=''){
  ...
  const label=role==='assistant'?'AI OPERATIONS ASSISTANT':'ON-CALL ENGINEER';
...
newSessionBtn?.addEventListener('click',()=>{
  ...
  localStorage.setItem(THREAD_KEY, threadId);
  renderSession();
    messages.innerHTML = `<div class="message assistant"><div class="avatar">A</div><div class="message-body"><div class="message-label">AI OPERATIONS ASSISTANT</div><div class="bubble intro">New incident memory session started. Describe the production issue and I’ll build context across your follow-up questions.</div></div></div>`;
